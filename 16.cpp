...
int dodaj(float a, float b)
{
    return a+b;
}
int odejmij(float a, float b)
{
    return a-b;
}
int pomnoz(float a, float b)
{
    return a*b;
}
int podziel(float a, float b)
{
    return a/b;
}
...
int main()
{
    ...
    if(y == "1") wynik = dodaj(liczba1, liczba2);
    else if(y == "2") wynik = odejmij(liczba1, liczba2);
    else if(y == "3") wynik = pomnoz(liczba1, liczba2);
    else if(y == "4") wynik = podziel(liczba1, liczba2);
